/* 
————————————————————————————————————
web3.eth.accounts.create()                                          //创建一个账户对象
web3.eth.accounts.encrypt(account.privateKey, this.createInfo.pwd   //将私钥加密变换为keystore v3标准格式

web3.eth.accounts.privateKeyToAccount(this.importInfo.privateKey)   //用指定的私钥创建一个账户对象
web3.eth.accounts.decrypt(this.importInfo.keystore, this.importInfo.pwd)    //解密给定的keystore对象，并创建账户

web3.eth.accounts.signTransaction({                                         //对交易进行签名，用来签名的账户地址需要首先解锁。
————————————————————————————————————
*/
...
var AddressLength = 26;//地址长度
var AddressPrefix = 25;//地址前缀
var NormalType = 87;//验证地址是正常
var ContractType = 88;//验证地址是合约

var KeyVersion3 = 3;//版本
var KeyCurrentVersion = 4;//当前版本
...
/* var keystore = { 
    "version": 3, 
    "id": "4ac12720-ec95-4434-99e7-1dfb0d859d44", 
    "address": "n1Lsn7nv6paMkwQjFKb9dbwZUeTxNVcdaJQ", 
    "crypto": { 
        "ciphertext": "cd9c478929216eac2a2338d057cbaadb9770d1c70180c72a1cefd3e6f98f7df3", 
        "cipherparams": { 
            "iv": "2f1ac69c00ce8f210f870ea536224f6d" 
        }, 
        "cipher": "aes-128-ctr", 
        "kdf": "scrypt", 
        "kdfparams": { 
            "dklen": 32, 
            "salt": "e018b975b5960cfce814bcbccdb02adfd591f7895d3789cbe62fe59f43415470", 
            "n": 4096, 
            "r": 8, 
            "p": 1 
        }, 
        "mac": "b5dcf35e57186309130c23c6dbb3f2196d05bbc12e9787bdfd9bd155d855a627", 
        "machash": "sha3256" 
    } 
} */
 ...
 * @constructor
 *
 * @param {Hash} priv Account private key. 帐户私钥
 * @param {String} path
 *
